...
public final class Constants {
    ...
    public static final double MOTOR_MAXIMUM_VELOCITY = 4.62;
    ...
    public static final int REAR_LEFT_ROTATE_SENSOR = 13;//drive module 1
    ...
    public static final int REAR_RIGHT_ROTATE_SENSOR = 12;//drive module 2
